...
<body ng-app="pingyougou" ng-controller="itemController" ng-init="loadSku()">
<#-- 引入head页面 -->
<#include "head.ftl">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd>
								<a href="javascript:;" class="{{isSelect('${spec.attributeName}','${item}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span>
										</a></dd>		
								</#list>
							</dl>
							</#list>
